...
2. Do "export CLUSTER_NODE_IPS=&ltips of all nodes in cluster&gt", and "export no_proxy=<ips of all nodes in cluster>,127.0.0.1,localhost,netmaster" in your shell
